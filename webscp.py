...
def main():
    ...
    st.markdown("""
        ...
        /* Core styles */
        .main-title { text-align: center; padding: 20px; color: #0d8eda; font-size: 3em; }
       
        /* Metrics and numbers */
        .stMetricValue div, .css-1wivap2 div, .stMetricLabel {
            color: #0d8eda !important;
            font-weight: 600 !important;
        }
       
        /* Scroll bar */
        ::-webkit-scrollbar { width: 12px; background-color: #FFE87C; }
        ...
        .product-text { color: #0d8eda; line-height: 1.6; }
